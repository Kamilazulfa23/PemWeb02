            ...
            <div class="card-body">
                <form action="/mobil/update/{{ $mobilData->id }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mobil" value="{{ $mobilData->mobil }}"required>
                    </div>
                    <div class="form-group">
                        <label for="">CC</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tahun_mobil"
                            value="{{ $mobilData->tahunMobil }}"required>
                    </div>
                    <div class="form-group">
                        <label for="">Nomor Polisi</label>
                        <input type="text" class="form-control" name="nomor_polisi"
                            value="{{ $mobilData->nomorPolisi }}"required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"name="foto" value="{{ $mobilData->foto }}"required>
                    </div>
